...
const features = [
  ...
  },
  {
    icon: Navigation,
    title: "GPS Tracking",
    description: "Real-time location tracking and safe zone monitoring",
    color: "teal",
    delay: 0.5
  },
  {
    icon: Shield,
    title: "Safe Zones",
    description: "Set up geofencing to keep your dog safe and secure",
    color: "nature",
    delay: 0.6
  }
]
    ...
    <section className="py-20 bg-gradient-to-br from-earth-50 to-teal-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            Pawfect Match brings together all the tools and features you need to give your dog the best life possible
          </motion.p>
        </div>
        ...
        >
          <div className="bg-gradient-to-r from-teal-500 to-orange-500 rounded-2xl p-8 text-white">
            ...
            <button className="bg-white text-teal-600 hover:bg-earth-50 px-8 py-4 rounded-full font-body font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
              Download App
            </button>
          </div>
        </motion.div>
